...
const contact = () => {
  return (
    <div>
        <section className="pl-8 pr-8 pb-28 md:pl-32 md:pr-32 md:pt-32">
            <div className=' items-center text-center flex justify-center pb-8 md:justify-start' >
                ...
                <hr className='w-0 md:w-full border-1 border-lightAccent' />
            </div>
