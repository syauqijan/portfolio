    ...
    <div>
        ...
        <div className='text-lg md:text-xl md:pr-64 md:justify-items-start md:text-left md:items-start'>
          ...
          <Reveal>
            ...
            <div className="flex w-full md:justify-start md:items-start pt-8">
                <form
                ref={formRef}
                ...
                <div className="flex justify-center md:justify-end">
                    <button
                        type='submit'
                        className='bg-quaternary hover:bg-quaternaryDark text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline'
                    >
