...
import MU2 from '../Assets/Images/Subject 4.png';
...
const projects = () => {
    ...
    return (
        <section id="projects" className="pr-8 pl-8 pb-28 ">
                        ...
                        <Menu.Items className='flex flex-col justify-center mb-5 focus:outline-none'>
                            <div className='py-1'>
                                <Menu.Item>
                                    ...
                                    <div className='my-5 md:my-0 rounded-lg overflow-hidden  md:mr-16 '>
                                        <img className="" src={project.image} alt="Logo Company" />
                                    </div>
                                    </div>
                                    ...
                                    <p className='text-lg md:text-xl my-2 text-justify'>{project.description}</p>
                                    <p className='text-lg md:text-xl my-2 text-justify text-quaternary'>Made with:
                                    </p>
