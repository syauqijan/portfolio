...
import MU3 from '../Assets/Images/Subject 6.png';
import MU4 from '../Assets/Images/Subject 7.png';
        ...
        <section id="projects" className="pr-8 pl-8 pb-28 md:pr-32 md:pl-32">
            ...
            <div className="overflow-hidden flex-col ">
                ...
                >
                    ...
                    <Menu.Button><p className='text-xl md:text-3xl my-2 font-bold text-left cursor-pointer' >{project.name}</p></Menu.Button>
                    <Transition
                        as={Fragment}
