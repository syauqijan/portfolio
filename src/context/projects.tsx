...
import MU from '../Assets/Images/mockupgff.jpg';
import MU2 from '../Assets/Images/musea.jpg';
...
const projects = () => {
    ...
    const projectsArray = [
        {
            name: 'Ganesha Film Festival Website',
    ...
    return (
        <section id="projects" className="pr-8 pl-8 ">
                <div className=' items-center  flex flex-row space-x-4 mb-10' >
                    <hr className='w-1/2 border-1 border-lightAccent' />
                    <h2 className=' text-4xl text-center font-poppins '>Projects<span className="text-quaternary">.</span></h2>
                </div>
            <div className="overflow-hidden flex-col md:text-left">
                {projectsArray.map((project, idx) => (
                <div
                    className='font-inter w-full flex flex-col md:px-16 lg:px-32 mb-10'
                    key={idx}
                >
                    <Menu as='div' className='cursor-pointer ' onClick={project.action}>
                    
                    <Menu.Button><p className='text-xl md:text-3xl my-2 font-bold text-left cursor-pointer' onClick={project.action}>{project.name}</p></Menu.Button>
                    <Transition
                        as={Fragment}
